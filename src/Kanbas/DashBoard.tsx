            ...
            <div className="card">
              ...
              >
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">Term: Fall 2024 | Section: 01<br />Full Stack software developer</p>
          ...
          <div className="card">
              ...
              >
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">Term: Fall 2024 | Section: 02<br />Python</p>
                  <button className="btn btn-primary"> Go </button>
                </div>
              </Link>
            </div>
          ...
          <div className="card">
              ...
              >
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">Term: Fall 2024 | Section: 02<br />Data Base Foundation</p>
                  <button className="btn btn-primary"> Go </button>
                </div>
              </Link>
            </div>
          ...
          <div className="card">
              ...
              >
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">Term: Fall 2024 | Section: 02<br />Software Engineering Foundation</p>
                  <button className="btn btn-primary"> Go </button>
                </div>
              </Link>
            </div>
          ...
          <div className="card">
              ...
              >
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">Term: Fall 2024 | Section: 02<br />AWS</p>
                  <button className="btn btn-primary"> Go </button>
                </div>
              </Link>
            </div>
          ...
          <div className="card">
              ...
              >
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">Term: Fall 2024 | Section: 02<br />OOD</p>
                  <button className="btn btn-primary"> Go </button>
                </div>
              </Link>
            </div>
          ...
          <div className="card">
              ...
              >
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">Term: Fall 2024 | Section: 02<br />Data Structure</p>
                  <button className="btn btn-primary"> Go </button>
                </div>
              </Link>
            </div>
